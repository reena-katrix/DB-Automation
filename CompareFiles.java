...
public class CompareFiles{
	...
	public void CompareFileContents(File dirA, File dirB)throws ParserConfigurationException, SAXException,IOException
	{
	    ...
	    for(int i=0;i<len;i++)
	    {
	      ...
	      ArrayList<HashMap<String, String>>result = new ArrayList<HashMap<String, String>>();
	  	  Node node = nodelist1.item(i);               //each property or each column heading
...
//	    System.out.println(Whole);
	    ...
	    for(int i=0;i<len2;i++)
	    {
	      //to store one column contents
	      ArrayList<HashMap<String, String>>result = new ArrayList<HashMap<String, String>>();
	  	  Node node = nodelist2.item(i);               //each property or each column heading
	  	  NamedNodeMap attributes = node.getAttributes();
	  	  parse.storeAttributes(attributes,result);
	  	  parse.getAllChildren(node,result);
