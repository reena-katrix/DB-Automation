...
public class TableComparison {
	...
	static String OldVersion = "OldVersion"; // give location of folders to be
												// created
	...
	public static void main(String[] args) throws ParserConfigurationException, SAXException, IOException {
		...
		File epnm0 = new File(oldFolderInput); // folder 1 in file format
		File epnm1 = new File(newFolderInput); // folder 2 in file format
		...
		input.ExtractFolder(epnm0, OldVersion); // src,dest
		input.ExtractFolder(epnm1, NewVersion); // src,dest
